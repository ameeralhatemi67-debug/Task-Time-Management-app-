...
enum SortOption { dateModified, dateCreated, title }
    ...
    return PopupMenuButton<String>(
      ...
      itemBuilder: (context) => [
        ...
        PopupMenuItem(
          value: 'view',
          child: Row(children: [
            Icon(isSlimView ? Icons.view_agenda : Icons.view_headline,
                size: 18, color: colors.textMain),
            const SizedBox(width: 8),
            Text(isSlimView ? "Card View" : "Slim View",
        ...
        PopupMenuItem(
          ...
          child: Row(children: [
            ...
            const SizedBox(width: 8),
            Text("Select Notes", style: TextStyle(color: colors.textMain)),
          ]),
        ),
        ...
        PopupMenuItem(
          child: SubmenuButton(
            menuChildren: [
              PopupMenuItem(
                onTap: () => onSortChanged(SortOption.dateModified),
                child: Text("Date Modified",
                    style: TextStyle(color: colors.textMain)),
              ),
              PopupMenuItem(
                onTap: () => onSortChanged(SortOption.dateCreated),
                child: Text("Date Created",
                    style: TextStyle(color: colors.textMain)),
              ),
              PopupMenuItem(
                onTap: () => onSortChanged(SortOption.title),
                child: Text("Title", style: TextStyle(color: colors.textMain)),
              ),
            ],
            child: Row(children: [
